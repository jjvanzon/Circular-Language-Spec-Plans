...
- [ ] Migrating from "Encircle Language Spec Revamp":
...
- [ ] Splitting off from "Encircle Language Spec Revamp":
...
- [ ] 'Fully OO' topics:
    ...
    - [ ] Operators: arithmetic, comparative, logical, bit, string
    - [ ] Enum types
    - [ ] Structs
    - [ ] Union types
    - [ ] Modifiers
