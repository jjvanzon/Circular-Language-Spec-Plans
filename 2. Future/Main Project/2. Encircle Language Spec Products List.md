...
This document is mostly a raw list of the products that can be produced within the project *Encircle Language Spec*. The goal and strategy were already described in detail in another document, called *Encircle Language Spec Strategy.*
