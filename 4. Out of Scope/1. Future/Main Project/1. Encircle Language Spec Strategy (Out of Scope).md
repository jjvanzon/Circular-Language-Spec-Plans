...
'Out of Scope' might not mean 'Deprecated', but more 'not part of the spec' or 'not for now'. They might be construct drafts, or topics about a broader perspective on things.
