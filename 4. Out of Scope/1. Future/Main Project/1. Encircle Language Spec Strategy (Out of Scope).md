...
The first 2 categories might still be found as sub-folders of the *Circle Language Spec* documentation, though not considered part of the spec.

The last category *Aspect Framework* was deemed *totally out of scope* of Circle Language Spec documentation: perhaps for a completely different project.
