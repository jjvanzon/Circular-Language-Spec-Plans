...
One thing might need to be mentioned is that the *Planning* part of the project, in which the whole of *Encircle Language Spec* project was replanned, went very well. But the making the *Black Box* article group spun out of control.
