...
Making Circular has been an ongoing project, since the end of the year 2000.
...
The strategy can still be found as version *2010-05-14 00* of the parent project *Circular Language Spec*.
...
I am doing *Circular Language Spec* projects, because I think maybe I should never stop doing that entirely.

I have finished two topics of Circular and I did it fast in my view. I used to have ideas about what topics I wanted to describe, but I have different ideas about that now. The design is getting close to a useable specification of a programming language, so I should look further than just to preserve my thoughts.

The strategy is about to change. The main strategy: making it possible for others to pick up my work, might not count anymore, because most of that is realized. I might work on Circular. But I have different ideas about which parts of it I want to realize, and I might start working towards an implementation of the software, instead of designing it on paper only. I might want to start thinking about what is required to make it this a fully useable product.
