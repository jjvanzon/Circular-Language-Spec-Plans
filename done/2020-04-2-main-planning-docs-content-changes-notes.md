...
### 2020-04-15 Done Circular Language Spec Planning Docs

- [x] I finished 'Circular Language Spec Strategy'.
- [x] 'Circular Language Spec Product List' seems finished.
...
- [x] 'Circular Language Spec Steps & Time Planning' should be next.
...
- [x] Done Circular Language Spec Ideas.
