...
- [Done](#done)
    - [2021-03-30 Done Scoping Circular-Language-Spec-Plans](#2021-03-30-done-scoping-circular-language-spec-plans)
    ...
    - [2020-05-14 Done Scoping | Split Up Circular Docs](#2020-05-14-done-scoping--split-up-circular-docs)
    ...
    - [2020-04-01 Done Scoping Circular Language Spec Planning Docs](#2020-04-01-done-scoping-circular-language-spec-planning-docs)
    - [2020-04-01 Done Scoping Circular Language Spec Planning Docs](#2020-04-01-done-scoping-circular-language-spec-planning-docs-1)
...
- [x] Splitting "Software System" / "Circular Language"
- [x] Splitting "Circular Docs" / "Experiment 3.0 Programming" (splitting documentation goals from programming goals.)
    - [x] Ideas.doc too
- [x] Splitting 'in scope' / 'out of scope' for Circular Language topics.
...
- [x] Splitting up "Language Spec" / "Broader View" / "Construct Drafts" / "Totally out of Scope"
    - [x] Circular-Language-Spec repository
    - [x] Circular-Language-Spec-Plans repository

### Done

#### 2021-03-30 Done Scoping Circular-Language-Spec-Plans

- [x] Circular-Language-Spec-Plans repository
    - [x] 'Out-of-scope' things might need distinction between "Broader View", "Construct Drafts" and not to be part of the Circular-Language-Spec-Plans at all.

#### 2020-12-05 Done Scope (for Git Migration)

- [x] Outline:
    - [x] It currently seems to be part of a Software System Docs repository.
    - [x] The parts about Circular might be isolated into a separate Git Repository.
...
- [x] NOTE:
    ...
    - [x] (Seems about Circular Language Spec vs 'the rest'.)
    - [x] (I am looking for Circular Docs vs 'the rest' now. (Circular Docs = language spec + construct drafts + broader view)
...
- [x] "Previous Versions\2005-07-28 00    Creator 0.4":
    ...
    - [x] But for a clear presentation of the Circular Language Spec, it seems to contribute much.
    ...
    - [x] Perhaps move it to one of the other parts of the Circular docs than the spec? Broader view or something?
- [x] Branching
...
- [x] "10. Circular Constructs Drafts\6. Expression\6. More Text Codes": 
    - [x] Has the sub-folders "1. Parser" and "2. Text Templates". I do not think those topics belong in Circular Construct Drafts. Maybe in Circular Broader View. But maybe those topics do not belong in Circular Language docs at all. More like framework. The index page includes other sub-topics, that used to be in that folder: such as 'other text codes', 'math' and 'assembly'. So some time in the past those topics were all in one place. I am not sure to exclude all of those topics from Circular Language and then maybe move them to the Framework part of the Software System docs, or whether some of it somehow has a place in broader perspective.
    - [x] They are probably there, because in the main subdivision of Software System, they might fall under 'Code' and that might be what made them end up in the proximity of Circular Language Spec. So it indeed probably does not belong under Circular at all, but it might belong under 'Code' in Software System.
- [x] By now I have:
    - [x] Categorized topics from "Language" over "Circular Language Spec", "Circular Constructs Drafts", "Circular Broader View" and "Framework". 
...
- [x] Commit
- [x] Some 'Operating System' topics might belong in a Circular Language topic group.
...
(Experiment 3.0 projects are software development projects, unlike Circular Docs projects, which are language design projects.)
...
- [x] These two documents may have content to weed out at one point:
    ...
    - [x] "Diagrams, Coding Principles & Coding Aspects Plan (obsolete).docx": I may want to consider moving this out of scope, or at least part of it.
        - [x] Marked some content in red.
        - [x] Still want to split the document up in two.
- [x] The other Circular Language Spec Plan docs seem fine regarding scoping for now.
...
- [x] ~~Or consider the 'Software System' topics to put in scope.~~
    - [x] ~~The content seems of not much use for inclusion in Circular Language Spec, not the planning docs nor the produced 'specification' docs.~~
    ...
    - [x] ~~Could be that this folder is relevant: "2003 - 2009 Software System Documentation"~~
        - [x] ~~"2007-10 Rethink Software System, Project Plan.doc":~~
            - [x] There it seems to start interweaving with Circular Language Spec topics.
            - [x] The goal might not really talk specifically about programming languages. The notes taken while doing that project, mention several topics about programming languages, but just naming larger parts, not details. Not really much can be found that goes specifically into Circular Language Spec and the diagram notation. I do not think much is of use in the Circular Language Spec Plan documentation. It seems 'Symbol attempts' is the real first effort put into the diagram notation, that is mentioned in these planning docs (perhaps aside from what's in the hour loggings, which have not been considered yet).
            - [x] I do not think I can even formulate just a few sentences 'this and that' has been done regarding Circular Language Spec in this project, while the project was also about larger parts. It's just that inconcrete.
        - [x] ~~"2009-04 01         Full Revision of Documentation    2009-04 - 2009-06"~~
            - [x] ~~"Software System Full Revision of Documentation, Goal.doc"~~
                ...
                - [x] ~~Only in general the Circular Language Spec is mentioned, but no content seems to be concretely about Circular Language Spec.~~
            - [x] ~~"Full Revision of Doc, Elements & Time Estim.doc"~~
                - [x] ~~"Main Modules: (19 articles, 90 sections)": There is the first time concrete work for Circular Language Spec is mentioned, done during the project "Full Revision of Documentation    2009-04 - 2009-06".~~
                - [x] ~~At "- Sub-Modules: (25 articles, 218 sections)" it starts going into a bit more detail about it.~~
                - [x] ~~Up until now, just some main parts of Circular Language Spec are named. Not sure if it is really that significant information to tell about projects and their execution.~~
            ...
            - [x] ~~"Software System Full Revision of Documentation, Reflection.doc"~~
                - [x] ~~Half way, this reflection turns into almost the literal content of what the goal is of the Circular Language Spec project.~~
                - [x] I think I can remove it. It is basically the strategy doc of Circular Language spec. Consider that later.
                - [x] ~~It is interesting to see that Circular Language Spec is exactly the next project after this.~~
                - [x] ~~So this is indeed the interlude to the Circular Language Spec project. I like to see those connections.~~
            - [x] ~~"02. Software System Full Revision of Documentation, Implementation, Reach Goal A.doc"~~
                - [x] ~~Has some detail about Circular Language Spec, but not much.~~
            - [x] ~~"04. Software System Full Revision of Documentation, Implementation, Reach Goal B.doc"~~
                - [x] ~~Among other things, lists main parts of Circular Language Spec again, for which contents/direction 'pages' were written.~~
    ...
    - [x] ~~Should any of that be included in the Circular Language Spec Plan docs?~~
        - [x] ~~"2003 - 2009 Software System Documentation" is sort of the prequel to Circular Language Spec. Haha.~~
        - [x] ~~And the "2001 - 2002 Symbol" phase starts with initial ideas about Circular language, and ends with the unfinished Symbol.doc, though not much was written down about the progress (though probably things are in hour loggings, not considered yet.)~~
    - [x] ~~Looking at "1. Software System.doc":~~
        - [x] ~~If none of this part of the planning docs is usable for inclusion in Circular Language Spec planning docs, it may be worth a peek at the actual document Software System.doc or the 'redirection pages'.~~
        - [x] ~~I like it. I do not think I see much content I might use for Circular Language Spec. From earlier ideas I had, I expected to find more. Perhaps I looked it over wrong. Or maybe now much is narrowed in scope, some more content from this document might not fall into scope anymore, making less of it very usable in Circular Language Spec. Just bits and pieces maybe, but I expect to find texts of similar content and quality near the topics of Circular Language Spec already.~~

#### 2020-04-01 Done Scoping Circular Language Spec Planning Docs

- [x] Circular Language Specs Done projects:
...
- [x] Details:
    ...
    - [x] Done project "Document Internet as a Single Computer" is out-of-scope...
        - [x] Lots of fundamental principles may become out-of-scope of the Circular Language Specs Project and might become part of a separate piece of documentation Circular Language Broader View or something.
        - [x] Not sure if right now I want to dump it in a Done folder with all these many projects in it.
        - [x] Might it matter? I am trying to isolate just Circular Language Spec from Other / anything else.

#### 2020-04-01 Done Scoping Circular Language Spec Planning Docs

- [x] Circular Language Spec Products doc: Move postponed work from Done section to the Postponed section.
- [x] The document "Experiment 3.0 Excluded Requirements" has topics that might be interesting for the Circular Language Spec project.
    - [x] Was at: Round Up looking for things to add/move from Experiment 3.0 Programming to Circular Language Spec.
- [x] Experiment 3.0 Programming, Preliminary Designs:
    - [x] Yes, definitely quite some useful texts in that document, that belong in the Circular Language Spec project.
    - [x] The texts seem to belong in the actual Circular Language Spec docs, not its planning docs.
    ...
    - [x] Do I move these texts to the appropriate spot in the Circular Docs now?
    - [x] Do I also move ideas from Sub-Projects there? Maybe those are too short to matter. And not really loose texts, but goals. Somewhere in the middle. So maybe I should copy/move some texts to the loose idea boxes of Circular Language Spec.
...
- [x] Lower contents:
    - [x] The idea of lower contents is described in planning docs not in Circular Docs Planning, but in '1. Experiment 3.0 Programming' planning.
...
- [x] The reason for calling it that, is to make it clearer what the project entails, separating it better from the super-project with the name 'Circular Docs', so that there is a clear distinction that one is about programming and the other is about documentation.
...
- [x] I just want clarity on the distinction between projects Circular Docs and Experiment 3.0 Programming, but giving it a clearly distinctive name.

#### 2020-03-16 Done Scoping Experiment 3.0 Requirements Docs

- [x] I moved content from Experiment 3.0 Requirements to Circular Language Products List.
...
This is too intense. I might stop again.
...
> (I notice I get inspired to like implementation projects for experiment 3.0. I feel the enthusiasm in it. I somehow stopped working on it, though. Also it is not my goal right now. The goal is publish Circular language design eventually.)
...
An idea for today might be to read "Experiment 3.0 Strategy". That document is supposed to be about software development, not language design. At least, that is the new goal I have with that document. Some things in it are relevant for the Circular Docs.  
"Goal of the Language" is where it is part about the language design, not so much the software development. I might use/move this text to the Circular Planning Docs.  
Was at "More Tips" processing things.

At what point am I going to be more rigorous in splitting off the Circular Planning Docs from the rest? Not yet, I think. It's still a mash up of both in the planning docs I am reading now.
...
Working on Circular Products.docx:
...
I am splitting off parts of Circular Products.docx into a separate document with the out-of-scope things.  
...
I read and reformulated some texts from "Circular Strategy.doc". 2 hours or so. I am now too tired.  
...
- [x] "Circular Language Spec" / "Circular Language Broader View" / "Circular Language JJ's Construct Proposals"
...
- [x] Out of scope:
    ...
    - [x] 'Software System': an abstraction layer above Circular.
        ...
        - [x] Then drop them somewhere in the Circular Language Spec documentation.
        - [x] Also for the planning docs: there are Software System Documentation out-of-scope projects. Perhaps part of it was Circular Language Design.
...
I think I interwove these things maybe a little too much. I just liked to subdivide things into a single system of subdivision into which everything fitted. Also, the interweaving may have been stimulated by my wanting to combine this 'Creator' project with the 'Circular' language project. The 'Creator' project was about model-driven development, aspects and framework more than being a real computer language. I wanted to combine the two things into a single system, so that may have lead me to try and put everything into a single system. Now, I think I know that Circular is the computer language and you could program model-driven aspect oriented software with it, if it can provide the aspect construct. Really, I think it helps to not try and solve all problems at once. 
