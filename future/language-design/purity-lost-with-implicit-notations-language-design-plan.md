...
I am having second thoughts about this. Maybe I might like to consider using a different symbol for Protected, so that these connectors, events and optional/required can get a less contrived notation.  
...
But if you might accidentally bend the half triangle at the end the wrong way, it might look like a protected access modifier. Well... maybe that is not definitive proof that there's an issue, but it's an indication of something might be confusing.
