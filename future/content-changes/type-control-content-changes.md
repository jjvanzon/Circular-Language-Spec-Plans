...
- [ ] ~ What I sort of expected to see when I opened this document, was an explanation on how type safety might be enforced in Circular. But what I saw was the different forms of generic and explicit, that explain things I already saw in other chapters.
- [ ] ~ I think maybe I try to prove in this text too much that the idea of generic and explicit works in Circular.
