...
- [x] Move the System Objects chapter further down in the chapters?
    ...
    - [x] I seem to be regularly in doubt about when which system command is called and under which circumstances. Not only might the chapter not seem to describe all those things in detail, but also it seems too early for that in the story. And also the basics of the language do not seem to depend on this.
