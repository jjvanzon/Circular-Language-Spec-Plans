...
These topics might not be part of the spec (yet). They may be found under the *Construct Drafts* or *Broader View* sections of the *Encircle-Language-Spec* documentation. These topics might be moved to separate doc for *Out of Scope* things. Perhaps some things may disappear from the project entirely.

- [ ] Construct Drafts | Input / Output | Language Design
- [ ] Construct Drafts | Aspects | Language Design
